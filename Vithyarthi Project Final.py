...
def calculate_gpa(num_courses, marks):
    ...
    for i in range(num_courses):
        ...
        if course_marks > 190:
            ...
            total_credits = 1
            break
        elif course_marks < 190:
            course_marks += 1  # Increment course marks to avoid zero

        # Calculate course points based on ceiling of marks divided by 19
        course_point = math.ceil(course_marks / 19)
...
if __name__ == "__main__":
    ...
    print("Your CGPA for this Semister is:", gpa)